...
export default function UsersPage() {
        ...
        const fetchAllData = async () => {
            ...
            try {
                ...
                if (!Array.isArray(companyData)) {
                    console.warn("Companies API returned non-array:", companyData);
                    // New (correct)
                    toast("Company list format invalid – using empty list", {
                        icon: '⚠️',               // optional warning emoji
                        style: {
                ...
                setError("Failed to load users, analytics or companies");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (modalUser.id) {
                await api.put(`/users/${modalUser.id}/`, userData);
    ...
    useEffect(() => {
        ...
        const fetchBranches = async () => {
            ...
            try {
                const res = await api.get(`/tenants/branches/?company_id=${modalUser.company_id}`);
