...
export default function Sidebar({ sidebarOpen, setSidebarOpen }: SidebarProps) {
    ...
    const menuGroups: MenuGroup[] = [
        ...
        },
        {
            ...
            items: [
                { title: "Sectors", href: "/dashboard/customer/sectors", icon: <GlobeAltIcon className="w-4 h-4" /> },
                { title: "Cells", href: "/dashboard/customer/cells", icon: <Squares2X2Icon className="w-4 h-4" /> },
                { title: "Villages", href: "/dashboard/customer/villages", icon: <MapPinIcon className="w-4 h-4" /> },
                { title: "Customers", href: "/dashboard/admin/customers", icon: <UsersIcon className="w-4 h-4" /> },
                { title: "Ledger Entries", href: "/dashboard/customer/ledger", icon: <DocumentTextIcon className="w-4 h-4" /> },
                { title: "Service Request", href: "/dashboard/customer/servicerequest", icon: <WrenchScrewdriverIcon className="w-4 h-4" /> },
                { title: "Service Orders", href: "/dashboard/customer/orders", icon: <WrenchScrewdriverIcon className="w-4 h-4" /> },
                { title: "Complaints", href: "/dashboard/customer/complaints", icon: <ExclamationTriangleIcon className="w-4 h-4" /> },
            ],
