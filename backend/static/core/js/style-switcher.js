...
const styleSwitherToggle = () => {
    const styleSwitcher = document.querySelector(".js-style-switcher");
    const styleSwitherToggle = document.querySelector(".js-style-switcher-toggler");

    styleSwitherToggle.addEventListener("click", function() {
...
const themeLightDark = () => {
  ...
  /* check for saved user preference , if any , 0n load of the website */  
